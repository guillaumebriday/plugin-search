    ...
    ***************************************************************************** */
    ...
    function Query(query, options) {
        ...
        query.prototype.filterSearch = function (collection) {
            if (this.searchTerms === null || this.searchTerms.filter(Boolean).length === 0) {
                return collection;
            }
    ...
    var index_cjs = {
        install: function (components, installOptions) {
